...
void Robot_DbusMove()
{
    if (dr16->alive())
    {
        while(dr16->get_s1()==1 || dr16->get_s1()==2)
        {
            ...
            motion->add_x_speed(y_speed);
            motion->add_y_speed(x_speed);
...
void Robot_Dbus_s11_s21()
{
    ...
    if(channel1>1024)
    {
        m3508_motor5->set_target_rpm(f_speed*0.2);
        m3508_motor6->set_target_rpm(-f_speed*0.2);
    ...
    else if(channel1<1024)
    {
        ...
        HAL_Delay(5);
        ft_scs6->write_position(350);
        HAL_Delay(5);
        ft_scs7->write_position(300);
        HAL_Delay(5);
        ft_scs8->write_position(300);
